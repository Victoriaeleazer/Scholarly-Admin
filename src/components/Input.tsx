...
export default function Input({prefix, id, placeholder, password=false, error, required, value, onChange, type, className}:props) {
  ...
  return (
    <div className='w-auto gap-1'>
        <div className={`w-full h-fit px-5 select-none py-4 ${className} outline-none flex gap-6 items-center justify-center border-none border-purple border-2 bg-[#101010] focus:border rounded-[20px]`}>
