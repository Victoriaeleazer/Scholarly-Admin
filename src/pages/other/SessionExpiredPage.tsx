...
export default function SessionExpiredPage({title, description, button, onClick}: props) {
  ...
  return (
    <div className="w-full h-full flex flex-col flex-center select-none text-secondary gap-4">
        ...
        <button onClick={()=>logout.mutate()} className="outline-none rounded-[25px] font-semibold bg-white flex flex-center h-[40px] w-[78px] text-black text-[13px] hover:bg-tertiary hover:text-white transition-all ease duration-200">
